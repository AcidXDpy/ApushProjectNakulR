    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-court-ink/82 backdrop-blur-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        <a href="#home" className="flex items-center gap-3">
          <span className="grid h-10 w-10 place-items-center rounded-lg bg-gradient-to-br from-court-green to-court-blue text-court-ink font-black">CV</span>
          <span>
        ...
        <a href="#quiz" className="focus-ring rounded-lg bg-court-green px-4 py-2 text-sm font-bold text-court-ink transition hover:bg-court-lime">
          Start Quiz
        </a>
      </nav>
    </header>
