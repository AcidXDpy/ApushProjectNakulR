      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <button onClick={onStartQuiz} className="focus-ring inline-flex items-center justify-center gap-2 rounded-lg bg-court-blue px-5 py-3 font-bold text-white transition hover:bg-court-green hover:text-court-ink">
              Take the quiz <ArrowRight size={18} />
            </button>
            <a href="#matchup" className="focus-ring inline-flex items-center justify-center rounded-lg border border-white/15 px-5 py-3 font-bold text-white transition hover:border-court-blue hover:bg-white/10">
        ...
        <div className="grid gap-4">
          <Card className="bg-gradient-to-br from-white/[0.08] via-court-blue/[0.06] to-court-lime/[0.06]">
