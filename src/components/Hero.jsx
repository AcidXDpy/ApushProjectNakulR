  ...
  return (
    <section id="home" className="section-pad relative overflow-hidden">
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          <p className="mb-4 inline-flex rounded-lg border border-court-green/30 bg-court-green/10 px-3 py-1 text-sm font-semibold text-court-lime">
            Frontend-only MVP
          </p>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <button onClick={onStartQuiz} className="focus-ring inline-flex items-center justify-center gap-2 rounded-lg bg-court-blue px-5 py-3 font-bold text-court-ink transition hover:bg-court-lime">
              Take the quiz <ArrowRight size={18} />
            </button>
            <a href="#matchup" className="focus-ring inline-flex items-center justify-center rounded-lg border border-white/15 px-5 py-3 font-bold text-white transition hover:border-court-green hover:bg-white/10">
        ...
        <div className="grid gap-4">
          <Card className="bg-gradient-to-br from-white/[0.08] to-court-green/[0.08]">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Card>
              <BarChart3 className="mb-4 text-court-green" />
